...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            console.log('API CONSULTADA EXITOSAMENTE'+ data);
    ...
    $(document).on('click', '#loginBtn', function(e) {
        ...
        $("#loading").fadeIn("fast", function() {
            ...
            form.append('apiuri', apiURI);
            form.append('meth', 'login');
            console.log('Ejecutando Login Usuario: '+ username + ' Password: '+password);
            //console.log(JSON.stringify(formData2.value));
            $.ajax({
               url: apiURI,
               type: 'POST',
               dataType: "json",
               ...
               data: form,
               success: function(data) {
                    console.log('Informacion recuperada: '+ data);
                    ...
                    if (data.scriptResp == "match") {
                        ...
                        console.log('USUARIO ENCONTRADO: '+data.userIntel.panelUsuario);
                        console.log('PANEL ENCONTRADO: '+ data.userIntel.idUsuario);
                        ...
                        console.log(JSON.stringify(data.userIntel));
               ...
               error: function(error) {
                  ...
                  console.log('Error fatal: aqui se mostrara'+JSON.stringify(jqXHR)+ '\neRROR THROW '+errorThrown);
              });
            e.preventDefault();
            return false;
        });
                                            ...
                                            <div class="masthead-content text-dark py-5 py-md-0">
                                                <form class="" method="post">
                                                    <div class="card logincard anim animLv2">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="card-title text-center text-white">VASACORP Local</div>
...
function showPanel(p, u) {
    ...
    console.log('ENTRANDO A METODO DE SHOWPALEN');
    console.log('DATA CONSULTAR : '+p+" "+u );
    var userIntel = window.localStorage.getItem("userIntel");
    var jsonObj = $.parseJSON('[' + userIntel + ']');
    userIntel = jsonObj[0];
    var formData = new FormData();
    ...
    return $.ajax({
        ...
        data: formData,
        success: function(data) {
        console.log('ShowPAnel SUCCESS');
            if (data.scriptResp == "loaded") {
            console.log('ShowPAnel LOADED');
                $('body div.page').remove();
                $('body script.controller').remove();
                if (data.panelName != 'login') {
                    console.log('ShowPAnel DIFERENTE DE LOGIN');
                    console.log(apiURI);
        ...
        error: function(error) {
        console.log('ShowPAnel ERROR: '+ JSON.stringify(error));
        if (userIntel) {
            if (userIntel.login == 'YES') {
                var localPanels = window.localStorage.getItem("localPanels");
                if (localPanels) {
...
function loadSideBar(u) {
    ...
    if (userData.sidebarUsuario == undefined) {
        ...
        return $.ajax({
            ...
            success: function(data) {
                if (data.scriptResp == "loaded") {
                    console.log(JSON.stringify(data.sideb))
